...
const BuscarPredio = () => {
    ...
    return (
        <>
            <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalBuscar">Buscar Predio</button>
                <hr />
                

            <div className="modal fade" id="modalBuscar">
